package com.astronuts.library.MovementManager.newdrive;
...
public class drive {
    ...
    public boolean isDone(){
        ...
        if(this.encoderLeft.Complete && this.encoderRight.Complete){
            complete = true;
        }
        if (complete==true) DbgLog.msg("in drive.isDone, complete=true");
        if (complete==false) DbgLog.msg("in drive.isDone, complete=false");
        return complete;
    }
}
