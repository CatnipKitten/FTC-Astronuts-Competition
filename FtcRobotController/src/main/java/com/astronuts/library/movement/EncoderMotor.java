...
>>>>>>> origin/preescot
    ...
    public boolean cnf(DcMotorController.RunMode Mode){
        ...
        if(this.motorMain.getMode() == Mode){
...
<<<<<<< HEAD
                ...
                case 5:
                    ...
                    if (Math.abs(this.motorMain.getCurrentPosition() - this.motorTarget) <= this.accuracy) {
                        ...
                        this.Case = 4;
                        this.Complete = true; //Set to true, as a new value can now be assigned.

                    } else {

                        this.Case = 6;
                        this.Complete = false; //The target has not been met, so flag is set to false.
...
>>>>>>> origin/preescot
    ...
    public String[] debugInfo(){
        ...
        debug[2] = this.motorMain.getMode().toString();
